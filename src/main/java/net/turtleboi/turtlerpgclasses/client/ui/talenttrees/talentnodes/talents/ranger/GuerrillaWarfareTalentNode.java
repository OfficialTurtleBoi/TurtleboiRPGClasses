...
public class GuerrillaWarfareTalentNode extends ActiveTalentButton {
    public GuerrillaWarfareTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress, CreateNarration createNarration) {
