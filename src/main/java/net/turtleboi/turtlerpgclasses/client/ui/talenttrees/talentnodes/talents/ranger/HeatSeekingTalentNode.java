...
public class HeatSeekingTalentNode extends PassiveTalentButton {
    public HeatSeekingTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress, CreateNarration createNarration) {
