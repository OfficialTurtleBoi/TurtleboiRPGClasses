...
public class CombatVeteranTalentNode extends StatTalentButton {
    public CombatVeteranTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress, CreateNarration createNarration) {
