...
public class ChargeTalentNode extends ActiveTalentButton {
    public ChargeTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress, CreateNarration createNarration) {
