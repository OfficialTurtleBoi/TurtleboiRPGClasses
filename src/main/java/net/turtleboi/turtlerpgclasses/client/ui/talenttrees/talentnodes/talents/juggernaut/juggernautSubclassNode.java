...
public class juggernautSubclassNode extends CapstoneTalentButton {
    public juggernautSubclassNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress, CreateNarration createNarration) {
