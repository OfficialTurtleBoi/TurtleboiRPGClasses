...
public class SwiftHandsTalentNode extends StatTalentButton {
    public SwiftHandsTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress, CreateNarration createNarration) {
