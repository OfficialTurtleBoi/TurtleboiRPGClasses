...
public class QuickRecoveryTalentNode extends StatTalentButton {
    public QuickRecoveryTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress, CreateNarration createNarration) {
