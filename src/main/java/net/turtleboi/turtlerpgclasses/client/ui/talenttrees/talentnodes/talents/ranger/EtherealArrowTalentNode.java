...
public class EtherealArrowTalentNode extends ActiveTalentButton {
    public EtherealArrowTalentNode(TalentTree talentTree, Talent talentClass, int x, int y, int maxPoints, int requiredPoints, boolean alwaysActive, OnPress onPress, CreateNarration createNarration) {
